...
const pageTitle = ref('NANTE_POINTE'); // Browser tab title
...
const customWelcomeMessage = ref(`Bonjour,<br><br> Acceptez-vous de répondre à quelques questions ?`); // HTML welcome message
